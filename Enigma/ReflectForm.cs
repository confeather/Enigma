...
namespace Enigma
{
    public partial class ReflectForm : Form
    {
        ...
        private void ReflecForm_Load(object sender, EventArgs e)
        {
            UpdateForm();
            loaded = true;
        }
        ...
        public void UpdateConnection(int firstIndex, int secondIndex)
        {
            ...
            configs[configs[firstIndex]] = configs[firstIndex];
            configs[configs[secondIndex]] = configs[secondIndex];
            configs[firstIndex] = secondIndex;
            configs[secondIndex] = firstIndex;
        ...
        {
            EventCenter.Broadcast<int[]>(EventType.ReflectorChange, configs);
            this.Close();
        }
    }
}
